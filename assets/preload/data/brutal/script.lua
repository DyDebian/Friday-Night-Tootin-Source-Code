...
local goMax = false; --Test
local goMin = false; --Test
local ii = 0; --Test
...
function onUpdate(elapsed)
    ...
    if shakearrow3 == true then
        for i=0,7 do
            setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] + 32 * math.sin((currentBeat + i*0) * math.pi))
            setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + 32 * math.cos((currentBeat + i*ii) * math.pi))
        end
    end

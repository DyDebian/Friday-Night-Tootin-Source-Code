...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Disco Beat Down",		"Beat Week 1 with no Misses.",				'week1_nomiss',			false],
		["GG EZ No RE",		"Beat Week 2 with no Misses.",				'week2_nomiss',			false],
		["Guitar Hero",		"Beat Week 3 with no Misses.",				'week3_nomiss',			false],
		["Swag Messiah!",		"Beat Week 4 with no Misses.",				'week4_nomiss',			false],
		["I Found You, Faker!",		"Beat Week 5 with no Misses.",				'week5_nomiss',			false],
		["Pandastical",		"Beat Week 6 with no Misses.",				'week6_nomiss',			false],
		["EYOOOO",		"Taunt 100 times",				'taunting',			 false],
		["Party Crasher",	"Beat Week 7 with no Misses.", 'week7_nomiss', false],
		["Gone Through Hell And Back", "Beat Week 8 with no Misses.", 'week8_nomiss', false],
		["Thats All You Got?", "Beat Week 666 with no Misses.", 'week666_nomiss', false]
	];

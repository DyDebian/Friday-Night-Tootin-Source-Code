...
class Controls extends FlxActionSet
{
	...
	var _skip = new FlxActionDigital(Action.SKIP);
	...
	public var SKIP(get, never):Bool;

	inline function get_SKIP()
		return _skip.check();
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.SKIP, keysMap.get('skip'));
			case Duo(true):

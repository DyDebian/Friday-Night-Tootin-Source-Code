...
// basically this old one that is buggy makes that when you minimize the game it continues, I don't know how to do that using windows events so cry about it.
class MP4HandlerOld
{
	...
	public function onVLCComplete()
	{
		...
		new FlxTimer().start(0.3, function(tmr:FlxTimer)
		{
			...
			{
				MusicBeatState.switchState(finishCallback);
			}
			vlcBitmap.dispose();

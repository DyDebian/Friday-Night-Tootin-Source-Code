...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		extraIcon = new HealthIcon('dad');
		extraIcon2 = new HealthIcon('dad');
		eventIcon.scrollFactor.set(1, 1);
		leftIcon.scrollFactor.set(1, 1);
		rightIcon.scrollFactor.set(1, 1);
		extraIcon.scrollFactor.set(1, 1);
		extraIcon2.scrollFactor.set(1, 1);

		eventIcon.setGraphicSize(30, 30);
		leftIcon.setGraphicSize(0, 45);
		rightIcon.setGraphicSize(0, 45);
		extraIcon.setGraphicSize(0, 45);
		extraIcon2.setGraphicSize(0, 45);
		extraIcon.visible = false;
		extraIcon2.visible = false;
		...
		extraIcon.setPosition(GRID_SIZE + 10, -100);
		extraIcon.x -= 32;
		extraIcon2.setPosition(GRID_SIZE * 5.2, -100);
		extraIcon2.x += 32;
	...
	function addSongUI():Void
	{
		...
		var player_layers:Array<String> = ["behind the opponent", "over the opponent"];
		var player_layers_2:Array<String> = ["behind the opponent2", "over the opponent2"];
		var player_layers_3:Array<String> = ["behind the boyfriend", "over the boyfriend"];
		...
		var player3DropDown = new FlxUIDropDownMenuCustom(gfDropDown.x + 140, gfDropDown.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		var player4DropDown = new FlxUIDropDownMenuCustom(gfDropDown.x + 140, gfDropDown.y + 40, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		var player5DropDown = new FlxUIDropDownMenuCustom(gfDropDown.x + 140, gfDropDown.y + 80, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
			_song.bf2 = characters[Std.parseInt(character)];
			updateHeads();
		});
		player5DropDown.selectedLabel = _song.bf2;
		blockPressWhileScrolling.push(player5DropDown);

		var check_activePlayer3 = new FlxUICheckBox(player3DropDown.x + 175, player3DropDown.y, null, null, "Active Opponent2", 100);
		check_activePlayer3.checked = _song.usePlayer3;
		check_activePlayer3.callback = function()
		{
			_song.usePlayer3 = check_activePlayer3.checked;
		};
		var check_activePlayer4 = new FlxUICheckBox(player4DropDown.x + 175, player4DropDown.y, null, null, "Active Opponent3", 100);
		check_activePlayer4.checked = _song.usePlayer4;
		check_activePlayer4.callback = function()
		{
			_song.usePlayer4 = check_activePlayer4.checked;
		};
		var check_activePlayer5 = new FlxUICheckBox(player5DropDown.x + 175, player5DropDown.y, null, null, "Active boyfriend2", 100);
		check_activePlayer5.checked = _song.useBf2;
		check_activePlayer5.callback = function()
		{
			_song.useBf2 = check_activePlayer5.checked;
		};
		var player3LayerDropDown = new FlxUIDropDownMenuCustom(check_activePlayer3.x + 140, check_activePlayer3.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray(player_layers, true), function(layer:String)
		{
			_song.player3Layer = player_layers[Std.parseInt(layer)];
		});
		player3LayerDropDown.selectedLabel = _song.player3Layer;
		blockPressWhileScrolling.push(player3LayerDropDown);
		var player4LayerDropDown = new FlxUIDropDownMenuCustom(check_activePlayer4.x + 140, check_activePlayer4.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray(player_layers_2, true), function(layer:String)
		{
			_song.player4Layer = player_layers_2[Std.parseInt(layer)];
		});
		player4LayerDropDown.selectedLabel = _song.player4Layer;
		blockPressWhileScrolling.push(player4LayerDropDown);
		var player5LayerDropDown = new FlxUIDropDownMenuCustom(check_activePlayer5.x + 140, check_activePlayer5.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray(player_layers_3, true), function(layer:String)
		{
			_song.bf2Layer = player_layers_3[Std.parseInt(layer)];
		});
		player5LayerDropDown.selectedLabel = _song.bf2Layer;
		blockPressWhileScrolling.push(player5LayerDropDown);
		...
		tab_group_song.add(new FlxText(player5DropDown.x, player5DropDown.y - 15, 0, 'Boyfriend2:'));
		tab_group_song.add(new FlxText(player4DropDown.x, player4DropDown.y - 15, 0, 'Opponent3:'));
		tab_group_song.add(new FlxText(player3LayerDropDown.x, player3LayerDropDown.y - 15, 0, 'Opponent2 Layer:'));
		tab_group_song.add(new FlxText(player4LayerDropDown.x, player4LayerDropDown.y - 15, 0, 'Opponent3 Layer:'));
		tab_group_song.add(new FlxText(player5LayerDropDown.x, player5LayerDropDown.y - 15, 0, 'Boyfriend2 Layer:'));
		...
		tab_group_song.add(check_activePlayer3);
		tab_group_song.add(check_activePlayer4);
		tab_group_song.add(check_activePlayer5);
		tab_group_song.add(player5LayerDropDown);
		tab_group_song.add(player4LayerDropDown);
		tab_group_song.add(player3LayerDropDown);
	...
	var check_p3Section:FlxUICheckBox;
	var check_p4Section:FlxUICheckBox;
	var check_bothSection:FlxUICheckBox;
	var check_bf2Section:FlxUICheckBox;
	var check_bothbfSection:FlxUICheckBox;
	...
	function addSectionUI():Void
	{
		...
		check_p3Section = new FlxUICheckBox(130, 60, null, null, "P3 section", 100);
		check_p3Section.name = 'check_p3';
		check_p3Section.checked = _song.notes[curSection].p3Section;

		check_bothSection = new FlxUICheckBox(130, 90, null, null, "P2 & P3 section", 100);
		check_bothSection.name = 'check_both';
		check_bothSection.checked = _song.notes[curSection].bothSection;

		check_p4Section = new FlxUICheckBox(130, 120, null, null, "P4 section", 100);
		check_p4Section.name = 'check_p4';
		check_p4Section.checked = _song.notes[curSection].p4Section;

		check_bf2Section = new FlxUICheckBox(130, 150, null, null, "Bf2 section", 100);
		check_bf2Section.name = 'check_bf2';
		check_bf2Section.checked = _song.notes[curSection].bf2Section;

		check_bothbfSection = new FlxUICheckBox(130, 180, null, null, "Bf & Bf2 section", 100);
		check_bothbfSection.name = 'check_bothbf';
		check_bothbfSection.checked = _song.notes[curSection].bothbfSection;
		...
		tab_group_section.add(check_p3Section);
		tab_group_section.add(check_p4Section);
		tab_group_section.add(check_bothSection);
		tab_group_section.add(check_bothbfSection);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		if (id == FlxUICheckBox.CLICK_EVENT)
		{
			...
			switch (label)
			{
				...
				case 'P3 section':
					_song.notes[curSection].p3Section = check.checked;

					updateGrid();
					updateHeads();
				case 'P2 & P3 section':
					_song.notes[curSection].bothSection = check.checked;

					updateGrid();
					updateHeads();
				case 'P4 section':
					_song.notes[curSection].p4Section = check.checked;

					updateGrid();
					updateHeads();
				case 'Bf2 section':
					_song.notes[curSection].bf2Section = check.checked;

					updateGrid();
					updateHeads();
				case 'Bf & Bf2 section':
					_song.notes[curSection].bothbfSection = check.checked;
	...
	function updateSectionUI():Void
	{
		...
		check_p3Section.checked = sec.p3Section;
		check_p4Section.checked = sec.p4Section;
		check_bothSection.checked = sec.bothSection;
		check_bf2Section.checked = sec.bf2Section;
		check_bothbfSection.checked = sec.bothbfSection;
	...
	function updateHeads():Void
	{
		...
		var healthIconP5:String = loadHealthIconFromCharacter(_song.bf2);

		if (_song.notes[curSection].mustHitSection)
		{
			if(_song.notes[curSection].bf2Section && !_song.notes[curSection].bothbfSection)
			{
				leftIcon.changeIcon(healthIconP5);
			}
			else
			{
				leftIcon.changeIcon(healthIconP1);
			}
			if(_song.notes[curSection].p3Section && !_song.notes[curSection].bothSection)
			{
				rightIcon.changeIcon(healthIconP3);
			}
			else if(_song.notes[curSection].p4Section)
			{
				rightIcon.changeIcon(healthIconP4);
			}
			else
			{
				rightIcon.changeIcon(healthIconP2);
			}
			if(_song.notes[curSection].bothSection)
			{
				extraIcon.setPosition(GRID_SIZE * 5.2, -100);
				extraIcon.x += 32;
				extraIcon.changeIcon(healthIconP3);
				extraIcon.visible = true;
			}
			else
			{
				extraIcon.visible = false;
			}
			if(_song.notes[curSection].bothbfSection)
			{
				extraIcon2.setPosition(GRID_SIZE + 10, -100);
				extraIcon2.x -= 32;
				extraIcon2.changeIcon(healthIconP5);
				extraIcon2.visible = true;
			}
			else
			{
				extraIcon2.visible = false;
		...
		else
		{
			...
			if(_song.notes[curSection].bf2Section && !_song.notes[curSection].bothbfSection)
			{
				rightIcon.changeIcon(healthIconP5);
			}
			else
			{
	...
	private function saveEvents()
	{
		...
		var eventsSong:SwagSong = {
			...
			bf2: _song.bf2,
			usePlayer3: _song.usePlayer3,
			usePlayer4: _song.usePlayer4,
			useBf2: _song.useBf2,
			player3Layer: _song.player3Layer,
			player4Layer: _song.player4Layer,
			bf2Layer: _song.bf2Layer,
